...
class Disk(NetBoxModel):
    ...
    part_number = models.CharField(max_length=50, help_text="The model number of the disk")
    serial_number = models.CharField(max_length=50, help_text="The serial number of the disk")
    firmware_version = models.CharField(max_length=50, help_text="The firmware version of the disk")
    wwn = models.CharField(max_length=50, help_text="The World Wide Name (WWN) of the disk")
