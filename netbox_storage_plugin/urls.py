...
urlpatterns = [
    ...
    path('disks/<int:pk>/', views.DiskView.as_view(), name='disk_detail'),
    ...
    path('disk-sets/<int:pk>/', views.DiskSetView.as_view(), name='diskset_detail'),
    ...
    path('logical-drives/<int:pk>/', views.LogicalDriveView.as_view(), name='logicaldrive_detail'),
    ...
    path('filesystems/<int:pk>/', views.FilesystemView.as_view(), name='filesystem_detail'),
    ...
    path('shares/<int:pk>/', views.ShareView.as_view(), name='share_detail'),
    ...
    path('san-volumes/<int:pk>/', views.SANVolumeView.as_view(), name='sanvolume_detail'),
    ...
    path('object-storages/<int:pk>/', views.ObjectStorageView.as_view(), name='objectstorage_detail'),
    ...
    path('virtual-disks/add/', views.VirtualDiskEditView.as_view(), name='virtualdisk_add'),
    path('virtual-disks/<int:pk>/edit/', views.VirtualDiskEditView.as_view(), name='virtualdisk_edit'),
    path('virtual-disks/<int:pk>/delete/', views.VirtualDiskDeleteView.as_view(), name='virtualdisk_delete'),
    path('virtual-disks/<int:pk>/', views.VirtualDiskView.as_view(), name='virtualdisk_detail'),
    path('virtual-disks/import/', views.VirtualDiskImportView.as_view(), name='virtualdisk_import'),
    path('virtual-disks/bulk-edit/', views.VirtualDiskBulkEditView.as_view(), name='virtualdisk_bulk_edit'),
    path('virtual-disks/bulk-delete/', views.VirtualDiskBulkDeleteView.as_view(), name='virtualdisk_bulk_delete'),
    path('virtual-disks/<int:pk>/changelog/', views.VirtualDiskChangeLogView.as_view(), name='virtualdisk_changelog'),
]